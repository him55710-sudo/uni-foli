...
_TEMPLATES: tuple[RenderTemplate, ...] = (
    ...
    RenderTemplate(
        id="consultant_diagnosis_basic",
        label="Consultant Diagnosis (Basic Report)",
        description="Basic admission diagnosis report with executive summary, dashboard, strengths, risks, and a focused action plan.",
        supported_formats=(RenderFormat.PDF,),
        category="diagnosis_report",
        section_schema=(
            "executive_verdict",
        ...
        visual_priority="medium",
        supports_provenance_appendix=True,
        recommended_for=("basic report", "quick consultant review", "school-safe diagnosis summary"),
        preview=TemplatePreviewMetadata(
            accent_color="#2563EB",
            surface_tone="consultant",
            cover_title="Basic consultant diagnosis",
            preview_sections=("Summary", "Dashboard", "Strengths", "Roadmap"),
            thumbnail_hint="A4 diagnosis report with score cards and compact consultant notes.",
        ),
        design_contract_id="diagnosis_report_basic_v3",
        section_pacing_profile="diagnosis_basic_paced",
    ),
    RenderTemplate(
        id="consultant_diagnosis_premium",
        label="Consultant Diagnosis (Premium Report)",
        description="Premium consultant diagnosis report with subject 세특, record network, topic strategy, interview frames, and roadmap.",
        supported_formats=(RenderFormat.PDF,),
        category="diagnosis_report",
        section_schema=(
            "cover_title_summary",
            ...
            "subject_humanities",
            "subject_stem",
            "major_competency_mapping",
            "record_network",
            "grade_growth_story",
            "strength_analysis",
            "weakness_risk_analysis",
            "recommended_report_directions_1",
            "recommended_report_directions_2",
            "avoid_repetition_topics",
            "student_record_rewrite",
            "interview_major_fit",
            "interview_inquiry_process",
            "interview_risk_defense",
            "roadmap",
            "priority_action_plan",
            "evidence_verification_appendix",
        ),
        density="dense",
        visual_priority="high",
        supports_provenance_appendix=True,
        recommended_for=("premium consultant report", "diagnosis artifact", "admissions strategy"),
        preview=TemplatePreviewMetadata(
            accent_color="#C9A227",
            surface_tone="premium_consultant",
            cover_title="Premium consultant diagnosis report",
            preview_sections=("Executive", "Subject Analysis", "Network", "Interview"),
            thumbnail_hint="Premium A4 report with score panels, subject cards, network matrix, and roadmap.",
        ),
        design_contract_id="diagnosis_report_premium_v3",
        section_pacing_profile="diagnosis_premium_structured",
    ),
    RenderTemplate(
        id="consultant_diagnosis_consultant",
        label="Consultant Diagnosis (Consultant Report)",
        description="Full consultant-grade diagnosis report with detailed subject diagnostics, narrative network, answer drafts, and redesign strategy.",
        supported_formats=(RenderFormat.PDF,),
        category="diagnosis_report",
        section_schema=(
            "cover_title_summary",
            ...
            "priority_action_plan",
            "evidence_verification_appendix",
            "consultant_answer_drafts",
            "record_redesign_strategy",
        ),
        density="dense",
        visual_priority="high",
        supports_provenance_appendix=True,
        recommended_for=("full consultant report", "record redesign", "interview preparation"),
        preview=TemplatePreviewMetadata(
            accent_color="#C9A227",
            surface_tone="premium_consultant",
            cover_title="Consultant diagnosis report",
            preview_sections=("Subject Detail", "Network", "Answer Drafts", "Redesign"),
            thumbnail_hint="Long-form consultant report with dense cards, matrices, timelines, and answer drafts.",
        ),
        design_contract_id="diagnosis_report_consultant_v3",
        section_pacing_profile="diagnosis_consultant_structured",
    ),
    RenderTemplate(
        id="consultant_diagnosis_premium_10p",
        label="Consultant Diagnosis (Premium Legacy Alias)",
        description="Legacy premium consultant diagnosis alias. New payloads normalize to Premium Report.",
        supported_formats=(RenderFormat.PDF,),
        category="diagnosis_report",
        section_schema=(
            "cover_title_summary",
